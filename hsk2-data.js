...
/* ------------------ الدرس 1: الزمن الماضي ------------------ */
{
  ...
  words: [
    { id:"v101", hanzi:"了", pinyin:"le", meaning_ar:"أداة اكتمال الفعل (زي 'قد' في الماضي)", audio:"audio/hsk2/v101.wav",
      example:{ hanzi:"我吃了饭。", pinyin:"wǒ chī le fàn", meaning_ar:"أنا أكلت الأكل." } },
    { id:"v102", hanzi:"昨天", pinyin:"zuótiān", meaning_ar:"إمبارح", audio:"audio/hsk2/v102.wav",
      example:{ hanzi:"我昨天去了学校。", pinyin:"wǒ zuótiān qù le xuéxiào", meaning_ar:"أنا رحت المدرسة إمبارح." } },
    { id:"v103", hanzi:"以前", pinyin:"yǐqián", meaning_ar:"قبل كده / زمان", audio:"audio/hsk2/v103.wav",
      example:{ hanzi:"我以前不会说中文。", pinyin:"wǒ yǐqián bú huì shuō zhōngwén", meaning_ar:"زمان ماكنتش بعرف أتكلم صيني." } },
    { id:"v104", hanzi:"去年", pinyin:"qùnián", meaning_ar:"السنة اللي فاتت", audio:"audio/hsk2/v104.wav",
      example:{ hanzi:"去年我去了中国。", pinyin:"qùnián wǒ qù le zhōngguó", meaning_ar:"السنة اللي فاتت رحت الصين." } },
    { id:"v105", hanzi:"上个月", pinyin:"shàng ge yuè", meaning_ar:"الشهر اللي فات", audio:"audio/hsk2/v105.wav",
      example:{ hanzi:"上个月我很忙。", pinyin:"shàng ge yuè wǒ hěn máng", meaning_ar:"الشهر اللي فات كنت مشغول." } },
    { id:"v106", hanzi:"以后", pinyin:"yǐhòu", meaning_ar:"بعد كده / في المستقبل", audio:"audio/hsk2/v106.wav",
      example:{ hanzi:"以后我想去日本。", pinyin:"yǐhòu wǒ xiǎng qù rìběn", meaning_ar:"بعد كده عايز أروح اليابان." } },
    { id:"v107", hanzi:"过", pinyin:"guo", meaning_ar:"أداة الخبرة (سبق و...)", audio:"audio/hsk2/v107.wav",
      example:{ hanzi:"我去过中国。", pinyin:"wǒ qù guo zhōngguó", meaning_ar:"سبق ورحت الصين." } },
    { id:"v108", hanzi:"刚才", pinyin:"gāngcái", meaning_ar:"من شوية / لسه من دقيقة", audio:"audio/hsk2/v108.wav",
...
/* ------------------ الدرس 2: المقارنة ------------------ */
{
  ...
  words: [
    { id:"v201", hanzi:"比", pinyin:"bǐ", meaning_ar:"أداة المقارنة (مثل)", audio:"audio/hsk2/v201.wav",
      example:{ hanzi:"他比我高。", pinyin:"tā bǐ wǒ gāo", meaning_ar:"هو أطول مني." } },
    { id:"v202", hanzi:"更", pinyin:"gèng", meaning_ar:"أكثر / بالأكثر", audio:"audio/hsk2/v202.wav",
      example:{ hanzi:"这个更好。", pinyin:"zhège gèng hǎo", meaning_ar:"ده أحسن." } },
    { id:"v203", hanzi:"最", pinyin:"zuì", meaning_ar:"الأكثر (أفعل التفضيل)", audio:"audio/hsk2/v203.wav",
      example:{ hanzi:"她最漂亮。", pinyin:"tā zuì piàoliang", meaning_ar:"هي الأجمل." } },
    { id:"v204", hanzi:"一样", pinyin:"yíyàng", meaning_ar:"زي بعض / متشابه", audio:"audio/hsk2/v204.wav",
      example:{ hanzi:"我们一样高。", pinyin:"wǒmen yíyàng gāo", meaning_ar:"إحنا في نفس الطول." } },
    { id:"v205", hanzi:"差", pinyin:"chà", meaning_ar:"أقل / ناقص", audio:"audio/hsk2/v205.wav",
      example:{ hanzi:"我的中文差一点。", pinyin:"wǒ de zhōngwén chà yìdiǎn", meaning_ar:"صينيتي ناقصة شوية." } },
    { id:"v206", hanzi:"比较", pinyin:"bǐjiào", meaning_ar:"نسبيًا / بالمقارنة", audio:"audio/hsk2/v206.wav",
      example:{ hanzi:"这里比较安静。", pinyin:"zhèlǐ bǐjiào ānjìng", meaning_ar:"هنا هادي نسبيًا." } },
    { id:"v207", hanzi:"还", pinyin:"hái", meaning_ar:"لسه / كمان", audio:"audio/hsk2/v207.wav",
      example:{ hanzi:"他还年轻。", pinyin:"tā hái niánqīng", meaning_ar:"هو لسه صغير." } },
    { id:"v208", hanzi:"极了", pinyin:"jíle", meaning_ar:"جدًا (مبالغة بعد الصفة)", audio:"audio/hsk2/v208.wav",
...
/* ------------------ الدرس 3: المشاعر والحالة النفسية ------------------ */
{
  ...
  words: [
    { id:"v301", hanzi:"高兴", pinyin:"gāoxìng", meaning_ar:"مبسوط / سعيد", audio:"audio/hsk2/v301.wav",
      example:{ hanzi:"我很高兴。", pinyin:"wǒ hěn gāoxìng", meaning_ar:"أنا مبسوط أوي." } },
    { id:"v302", hanzi:"难过", pinyin:"nánguò", meaning_ar:"حزين", audio:"audio/hsk2/v302.wav",
      example:{ hanzi:"她很难过。", pinyin:"tā hěn nánguò", meaning_ar:"هي حزينة أوي." } },
    { id:"v303", hanzi:"生气", pinyin:"shēngqì", meaning_ar:"زعلان / غضبان", audio:"audio/hsk2/v303.wav",
      example:{ hanzi:"他生气了。", pinyin:"tā shēngqì le", meaning_ar:"هو زعل." } },
    { id:"v304", hanzi:"害怕", pinyin:"hàipà", meaning_ar:"خايف", audio:"audio/hsk2/v304.wav",
      example:{ hanzi:"我害怕黑。", pinyin:"wǒ hàipà hēi", meaning_ar:"أنا خايف من الضلمة." } },
    { id:"v305", hanzi:"担心", pinyin:"dānxīn", meaning_ar:"قلقان", audio:"audio/hsk2/v305.wav",
      example:{ hanzi:"别担心。", pinyin:"bié dānxīn", meaning_ar:"متقلقيش." } },
    { id:"v306", hanzi:"累", pinyin:"lèi", meaning_ar:"تعبان", audio:"audio/hsk2/v306.wav",
      example:{ hanzi:"我今天很累。", pinyin:"wǒ jīntiān hěn lèi", meaning_ar:"أنا تعبان النهارده." } },
    { id:"v307", hanzi:"舒服", pinyin:"shūfu", meaning_ar:"مرتاح / كويس (صحيًا)", audio:"audio/hsk2/v307.wav",
      example:{ hanzi:"我不舒服。", pinyin:"wǒ bù shūfu", meaning_ar:"مش حاسس إني كويس." } },
    { id:"v308", hanzi:"讨厌", pinyin:"tǎoyàn", meaning_ar:"يكره / يزهق من", audio:"audio/hsk2/v308.wav",
...
/* ------------------ الدرس 4: الجسم والصحة ------------------ */
{
  ...
  words: [
    { id:"v401", hanzi:"头", pinyin:"tóu", meaning_ar:"راس", audio:"audio/hsk2/v401.wav",
      example:{ hanzi:"我头疼。", pinyin:"wǒ tóu téng", meaning_ar:"دماغي بتوجعني." } },
    { id:"v402", hanzi:"肚子", pinyin:"dùzi", meaning_ar:"بطن", audio:"audio/hsk2/v402.wav",
      example:{ hanzi:"我肚子疼。", pinyin:"wǒ dùzi téng", meaning_ar:"بطني بتوجعني." } },
    { id:"v403", hanzi:"疼", pinyin:"téng", meaning_ar:"بيوجع", audio:"audio/hsk2/v403.wav",
      example:{ hanzi:"哪儿疼？", pinyin:"nǎr téng", meaning_ar:"فين بيوجعك؟" } },
    { id:"v404", hanzi:"感冒", pinyin:"gǎnmào", meaning_ar:"برد (مرض)", audio:"audio/hsk2/v404.wav",
      example:{ hanzi:"我感冒了。", pinyin:"wǒ gǎnmào le", meaning_ar:"أنا مبرد." } },
    { id:"v405", hanzi:"医院", pinyin:"yīyuàn", meaning_ar:"مستشفى", audio:"audio/hsk2/v405.wav",
      example:{ hanzi:"去医院。", pinyin:"qù yīyuàn", meaning_ar:"روح المستشفى." } },
    { id:"v406", hanzi:"医生", pinyin:"yīshēng", meaning_ar:"دكتور", audio:"audio/hsk2/v406.wav",
      example:{ hanzi:"他是医生。", pinyin:"tā shì yīshēng", meaning_ar:"هو دكتور." } },
    { id:"v407", hanzi:"药", pinyin:"yào", meaning_ar:"دوا", audio:"audio/hsk2/v407.wav",
      example:{ hanzi:"吃药。", pinyin:"chī yào", meaning_ar:"خد الدوا." } },
    { id:"v408", hanzi:"生病", pinyin:"shēngbìng", meaning_ar:"يمرض", audio:"audio/hsk2/v408.wav",
...
/* ------------------ الدرس 5: الهوايات ووقت الفراغ ------------------ */
{
  ...
  words: [
    { id:"v501", hanzi:"爱好", pinyin:"àihào", meaning_ar:"هواية", audio:"audio/hsk2/v501.wav",
      example:{ hanzi:"我的爱好是画画。", pinyin:"wǒ de àihào shì huàhuà", meaning_ar:"هوايتي الرسم." } },
    { id:"v502", hanzi:"游泳", pinyin:"yóuyǒng", meaning_ar:"يعوم", audio:"audio/hsk2/v502.wav",
      example:{ hanzi:"我喜欢游泳。", pinyin:"wǒ xǐhuan yóuyǒng", meaning_ar:"بحب العوم." } },
    { id:"v503", hanzi:"唱歌", pinyin:"chànggē", meaning_ar:"يغني", audio:"audio/hsk2/v503.wav",
      example:{ hanzi:"她唱歌唱得很好。", pinyin:"tā chànggē chàng de hěn hǎo", meaning_ar:"هي بتغني كويس أوي." } },
    { id:"v504", hanzi:"跳舞", pinyin:"tiàowǔ", meaning_ar:"يرقص", audio:"audio/hsk2/v504.wav",
      example:{ hanzi:"我们去跳舞吧。", pinyin:"wǒmen qù tiàowǔ ba", meaning_ar:"يلا نروح نرقص." } },
    { id:"v505", hanzi:"运动", pinyin:"yùndòng", meaning_ar:"رياضة", audio:"audio/hsk2/v505.wav",
      example:{ hanzi:"我每天运动。", pinyin:"wǒ měitiān yùndòng", meaning_ar:"باتمرن كل يوم." } },
    { id:"v506", hanzi:"旅游", pinyin:"lǚyóu", meaning_ar:"يسافر / سياحة", audio:"audio/hsk2/v506.wav",
      example:{ hanzi:"我喜欢旅游。", pinyin:"wǒ xǐhuan lǚyóu", meaning_ar:"بحب السفر." } },
    { id:"v507", hanzi:"画画", pinyin:"huàhuà", meaning_ar:"يرسم", audio:"audio/hsk2/v507.wav",
      example:{ hanzi:"他会画画。", pinyin:"tā huì huàhuà", meaning_ar:"هو بيعرف يرسم." } },
    { id:"v508", hanzi:"听音乐", pinyin:"tīng yīnyuè", meaning_ar:"يسمع موسيقى", audio:"audio/hsk2/v508.wav",
...
/* ------------------ الدرس 6: المواصلات والسفر ------------------ */
{
  ...
  words: [
    { id:"v601", hanzi:"飞机", pinyin:"fēijī", meaning_ar:"طيارة", audio:"audio/hsk2/v601.wav",
      example:{ hanzi:"坐飞机去。", pinyin:"zuò fēijī qù", meaning_ar:"نروح بالطيارة." } },
    { id:"v602", hanzi:"火车", pinyin:"huǒchē", meaning_ar:"قطر", audio:"audio/hsk2/v602.wav",
      example:{ hanzi:"火车站在哪儿？", pinyin:"huǒchēzhàn zài nǎr", meaning_ar:"محطة القطر فين؟" } },
    { id:"v603", hanzi:"出租车", pinyin:"chūzūchē", meaning_ar:"تاكسي", audio:"audio/hsk2/v603.wav",
      example:{ hanzi:"我们坐出租车。", pinyin:"wǒmen zuò chūzūchē", meaning_ar:"هناخد تاكسي." } },
    { id:"v604", hanzi:"公共汽车", pinyin:"gōnggòng qìchē", meaning_ar:"أتوبيس", audio:"audio/hsk2/v604.wav",
      example:{ hanzi:"我坐公共汽车上班。", pinyin:"wǒ zuò gōnggòng qìchē shàngbān", meaning_ar:"باروح الشغل بالأتوبيس." } },
    { id:"v605", hanzi:"骑自行车", pinyin:"qí zìxíngchē", meaning_ar:"يركب عجلة", audio:"audio/hsk2/v605.wav",
      example:{ hanzi:"他骑自行车来的。", pinyin:"tā qí zìxíngchē lái de", meaning_ar:"هو جه بالعجلة." } },
    { id:"v606", hanzi:"开车", pinyin:"kāichē", meaning_ar:"يسوق عربية", audio:"audio/hsk2/v606.wav",
      example:{ hanzi:"我不会开车。", pinyin:"wǒ bú huì kāichē", meaning_ar:"أنا مش عارف أسوق." } },
    { id:"v607", hanzi:"走路", pinyin:"zǒulù", meaning_ar:"يمشي على رجليه", audio:"audio/hsk2/v607.wav",
      example:{ hanzi:"我走路去。", pinyin:"wǒ zǒulù qù", meaning_ar:"هامشي وأروح." } },
    { id:"v608", hanzi:"机场", pinyin:"jīchǎng", meaning_ar:"مطار", audio:"audio/hsk2/v608.wav",
...
/* ------------------ الدرس 7: الأفعال المساعدة ------------------ */
{
  ...
  words: [
    { id:"v701", hanzi:"想", pinyin:"xiǎng", meaning_ar:"عايز / نفسي في", audio:"audio/hsk2/v701.wav",
      example:{ hanzi:"我想喝茶。", pinyin:"wǒ xiǎng hē chá", meaning_ar:"نفسي أشرب شاي." } },
    { id:"v702", hanzi:"要", pinyin:"yào", meaning_ar:"عايز / لازم", audio:"audio/hsk2/v702.wav",
      example:{ hanzi:"我要走了。", pinyin:"wǒ yào zǒu le", meaning_ar:"لازم أمشي دلوقتي." } },
    { id:"v703", hanzi:"会", pinyin:"huì", meaning_ar:"يعرف يعمل (مهارة متعلمة)", audio:"audio/hsk2/v703.wav",
      example:{ hanzi:"我会做饭。", pinyin:"wǒ huì zuòfàn", meaning_ar:"أنا بعرف أطبخ." } },
    { id:"v704", hanzi:"能", pinyin:"néng", meaning_ar:"يقدر (قدرة/إذن)", audio:"audio/hsk2/v704.wav",
      example:{ hanzi:"我能帮你。", pinyin:"wǒ néng bāng nǐ", meaning_ar:"أقدر أساعدك." } },
    { id:"v705", hanzi:"可以", pinyin:"kěyǐ", meaning_ar:"مسموح / ممكن", audio:"audio/hsk2/v705.wav",
      example:{ hanzi:"我可以进来吗？", pinyin:"wǒ kěyǐ jìnlái ma", meaning_ar:"أقدر أدخل؟" } },
    { id:"v706", hanzi:"应该", pinyin:"yīnggāi", meaning_ar:"المفروض / لازم", audio:"audio/hsk2/v706.wav",
      example:{ hanzi:"你应该休息。", pinyin:"nǐ yīnggāi xiūxi", meaning_ar:"المفروض ترتاح." } },
    { id:"v707", hanzi:"得", pinyin:"děi", meaning_ar:"لازم (حتمية)", audio:"audio/hsk2/v707.wav",
      example:{ hanzi:"我得走了。", pinyin:"wǒ děi zǒu le", meaning_ar:"لازم أمشي." } },
    { id:"v708", hanzi:"不用", pinyin:"búyòng", meaning_ar:"مش محتاج / مفيش داعي", audio:"audio/hsk2/v708.wav",
...
/* ------------------ الدرس 8: المكالمات والمواعيد ------------------ */
{
  ...
  words: [
    { id:"v801", hanzi:"喂", pinyin:"wéi", meaning_ar:"ألو (لما ترد التليفون)", audio:"audio/hsk2/v801.wav",
      example:{ hanzi:"喂，你好！", pinyin:"wéi, nǐhǎo", meaning_ar:"ألو، أهلًا!" } },
    { id:"v802", hanzi:"打电话", pinyin:"dǎ diànhuà", meaning_ar:"يتصل بالتليفون", audio:"audio/hsk2/v802.wav",
      example:{ hanzi:"我给你打电话。", pinyin:"wǒ gěi nǐ dǎ diànhuà", meaning_ar:"هاتصل بيك." } },
    { id:"v803", hanzi:"手机", pinyin:"shǒujī", meaning_ar:"موبايل", audio:"audio/hsk2/v803.wav",
      example:{ hanzi:"我的手机没电了。", pinyin:"wǒ de shǒujī méi diàn le", meaning_ar:"موبايلي البطارية خلصت." } },
    { id:"v804", hanzi:"等", pinyin:"děng", meaning_ar:"يستنى", audio:"audio/hsk2/v804.wav",
      example:{ hanzi:"请等一下。", pinyin:"qǐng děng yíxià", meaning_ar:"استني لحظة من فضلك." } },
    { id:"v805", hanzi:"见面", pinyin:"jiànmiàn", meaning_ar:"يقابل", audio:"audio/hsk2/v805.wav",
      example:{ hanzi:"我们明天见面。", pinyin:"wǒmen míngtiān jiànmiàn", meaning_ar:"هنتقابل بكرة." } },
    { id:"v806", hanzi:"约", pinyin:"yuē", meaning_ar:"يحدد ميعاد", audio:"audio/hsk2/v806.wav",
      example:{ hanzi:"我们约在公园。", pinyin:"wǒmen yuē zài gōngyuán", meaning_ar:"حددنا نتقابل في الحديقة." } },
    { id:"v807", hanzi:"迟到", pinyin:"chídào", meaning_ar:"يتأخر", audio:"audio/hsk2/v807.wav",
      example:{ hanzi:"对不起，我迟到了。", pinyin:"duìbuqǐ, wǒ chídào le", meaning_ar:"آسف، اتأخرت." } },
    { id:"v808", hanzi:"安排", pinyin:"ānpái", meaning_ar:"يرتب / ينظم", audio:"audio/hsk2/v808.wav",
...
/* ------------------ الدرس 9: السبب والنتيجة ------------------ */
{
  ...
  words: [
    { id:"v901", hanzi:"因为", pinyin:"yīnwèi", meaning_ar:"لأن", audio:"audio/hsk2/v901.wav",
      example:{ hanzi:"因为下雨，我没去。", pinyin:"yīnwèi xiàyǔ, wǒ méi qù", meaning_ar:"لأنها كانت بتمطر، ماروحتش." } },
    { id:"v902", hanzi:"所以", pinyin:"suǒyǐ", meaning_ar:"لذلك / عشان كده", audio:"audio/hsk2/v902.wav",
      example:{ hanzi:"所以我很累。", pinyin:"suǒyǐ wǒ hěn lèi", meaning_ar:"عشان كده أنا تعبان." } },
    { id:"v903", hanzi:"但是", pinyin:"dànshì", meaning_ar:"لكن", audio:"audio/hsk2/v903.wav",
      example:{ hanzi:"我想去，但是没时间。", pinyin:"wǒ xiǎng qù, dànshì méi shíjiān", meaning_ar:"نفسي أروح بس معنديش وقت." } },
    { id:"v904", hanzi:"虽然", pinyin:"suīrán", meaning_ar:"رغم إن / مع إن", audio:"audio/hsk2/v904.wav",
      example:{ hanzi:"虽然很难，但是我喜欢。", pinyin:"suīrán hěn nán, dànshì wǒ xǐhuan", meaning_ar:"رغم إنه صعب، بس بحبه." } },
    { id:"v905", hanzi:"可是", pinyin:"kěshì", meaning_ar:"لكن (نفس 但是)", audio:"audio/hsk2/v905.wav",
      example:{ hanzi:"可是我不想去。", pinyin:"kěshì wǒ bù xiǎng qù", meaning_ar:"بس أنا مش عايز أروح." } },
    { id:"v906", hanzi:"而且", pinyin:"érqiě", meaning_ar:"كمان / وكمان", audio:"audio/hsk2/v906.wav",
      example:{ hanzi:"便宜，而且好吃。", pinyin:"piányi, érqiě hǎochī", meaning_ar:"رخيص، وكمان طعمه حلو." } },
    { id:"v907", hanzi:"除了", pinyin:"chúle", meaning_ar:"ماعدا / غير", audio:"audio/hsk2/v907.wav",
      example:{ hanzi:"除了他，都来了。", pinyin:"chúle tā, dōu lái le", meaning_ar:"ماعدا هو، الكل جه." } },
    { id:"v908", hanzi:"特别", pinyin:"tèbié", meaning_ar:"خصوصي / جدًا", audio:"audio/hsk2/v908.wav",
...
/* ------------------ الدرس 10: التخطيط للمستقبل والتكرار ------------------ */
{
  ...
  words: [
    { id:"v1001", hanzi:"还", pinyin:"hái", meaning_ar:"لسه / برضه", audio:"audio/hsk2/v1001.wav",
      example:{ hanzi:"我还没吃饭。", pinyin:"wǒ hái méi chīfàn", meaning_ar:"أنا لسه ماكلتش." } },
    { id:"v1002", hanzi:"再", pinyin:"zài", meaning_ar:"تاني (في المستقبل)", audio:"audio/hsk2/v1002.wav",
      example:{ hanzi:"我们再见。", pinyin:"wǒmen zàijiàn", meaning_ar:"هنشوف بعض تاني." } },
    { id:"v1003", hanzi:"也", pinyin:"yě", meaning_ar:"كمان / برضه", audio:"audio/hsk2/v1003.wav",
      example:{ hanzi:"我也想去。", pinyin:"wǒ yě xiǎng qù", meaning_ar:"أنا كمان عايز أروح." } },
    { id:"v1004", hanzi:"一起", pinyin:"yìqǐ", meaning_ar:"مع بعض", audio:"audio/hsk2/v1004.wav",
      example:{ hanzi:"我们一起去吧。", pinyin:"wǒmen yìqǐ qù ba", meaning_ar:"يلا نروح مع بعض." } },
    { id:"v1005", hanzi:"已经", pinyin:"yǐjīng", meaning_ar:"خلاص / بالفعل", audio:"audio/hsk2/v1005.wav",
      example:{ hanzi:"我已经吃了。", pinyin:"wǒ yǐjīng chī le", meaning_ar:"أنا خلاص كلت." } },
    { id:"v1006", hanzi:"快要...了", pinyin:"kuàiyào...le", meaning_ar:"على وشك / قرب", audio:"audio/hsk2/v1006.wav",
      example:{ hanzi:"我快要到了。", pinyin:"wǒ kuàiyào dào le", meaning_ar:"أنا قربت أوصل." } },
    { id:"v1007", hanzi:"计划", pinyin:"jìhuà", meaning_ar:"خطة", audio:"audio/hsk2/v1007.wav",
      example:{ hanzi:"你有什么计划？", pinyin:"nǐ yǒu shénme jìhuà", meaning_ar:"عندك إيه خطط؟" } },
    { id:"v1008", hanzi:"打算", pinyin:"dǎsuàn", meaning_ar:"ينوي", audio:"audio/hsk2/v1008.wav",
